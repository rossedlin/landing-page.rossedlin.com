...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
	...
	<div class="collapse navbar-collapse" id="navbarResponsive">
		<ul class="navbar-nav ml-auto">
			<li class="nav-item">
				<a class="nav-link" href="http://www.rossedlin.com/" target="_blank">Website</a>
			</li>
			<li class="nav-item">
...
<footer>
	<div class="container">
		<p>&copy; <?= date('Y') ?> <a href="http://www.rossedlin.com/" target="_blank" style="color: rgba(255, 255, 255, 0.5);">Ross Edlin.</a> All Rights Reserved.</p>
	</div>
</footer>
